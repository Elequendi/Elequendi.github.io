...
$(window).resize( () => {
let breite = $text.width();
let hoehe = $text.height();
let flache = ((breite*hoehe)**(1/2)/12);
$text.css("font-size", flache);
});
